#ifndef H_KNAPSACK_SOLVER_DP
#define H_KNAPSACK_SOLVER_DP
...
class KnapsackSolverDP : public KnapsackSolverAbstract {
    ...
    void solve_impl(double sack_size, int start_index);
public:
    KnapsackSolverDP(std::vector<double> weights, std::vector<double> values);
