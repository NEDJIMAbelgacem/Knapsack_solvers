#ifndef H_UNBOUNDEDKNAPSACK_SOLVER_BNB
#define H_UNBOUNDEDKNAPSACK_SOLVER_BNB
...
class UnboundedKnapsackSolverBnB : public KnapsackSolverAbstract {
private:
...
public:
    UnboundedKnapsackSolverBnB(std::vector<double> weights, std::vector<double> values);
